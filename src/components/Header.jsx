  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="relative z-10 max-w-3xl text-left text-[var(--brand-light)]"
      >
        ...
        <button
          ...
          onClick={() =>
            window.open(
              "https://docs.google.com/forms/d/e/1FAIpQLSfh3eP7up1w6jwl7dONh2GpNmGFbOlvhW-UTzPbbhcK41fKkQ/viewform",
              "_blank"
            )
          }
        >
