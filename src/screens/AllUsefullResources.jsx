...
const AllUsefullResources = () => {
  ...
  return (
    <section className="mt-25 relative py-16 bg-gradient-to-br from-[var(--brand-light)] via-white to-[var(--brand-light)] overflow-hidden">
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 place-items-center">
      {ResourceLinks?.map((item, index) => (
        ...
        >
          ...
          {/* Category */}
          <p className="text-lg font-semibold text-[var(--brand-dark)] text-center">
            {item.category}
          </p>
        </div>
      ))}
...
export default AllUsefullResources;